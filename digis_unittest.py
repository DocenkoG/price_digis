...
class DigisUnittest(unittest.TestCase):
    def setUp(self):
        ...
        self.base_url = "https://digis.ru/"
        self.verificationErrors = []
        self.accept_next_alert = True

    
    def test_digis_unit(self):
        driver = self.driver
        driver.get(self.base_url + "/personal/profile/")
        driver.find_element_by_name("USER_LOGIN").clear()
        driver.find_element_by_name("USER_LOGIN").send_keys("egn@av-prom.ru")
        driver.find_element_by_name("USER_PASSWORD").clear()
        driver.find_element_by_name("USER_PASSWORD").send_keys("JundXc23")
        driver.find_element_by_name("Login").click()
        driver.find_element_by_xpath(u"(//a[contains(text(),'Прайс-лист')])[2]").click()
        driver.find_element_by_css_selector("div.easyfix > a").click()
        time.sleep(20)
